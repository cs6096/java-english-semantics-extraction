 ...
 */
package net.scao.semanticmapping.linguisticconstuct;

import net.scao.semanticmapping.conceptual.ConceptUniverse;
import net.scao.semanticmapping.core.TextConstructIndexMap;
import net.scao.semanticmapping.deprecated.EnglishOntology.ActionProcess;
import net.scao.semanticmapping.deprecated.EnglishOntology.Quality;
