...
import net.scao.semanticmapping.debug.DebugPrint;
import net.scao.semanticmapping.factory.Factory;
...
import net.scao.semanticmapping.util.NLPStringUtil;
...
//		testOnTestSentence();
	...
	public static void testingPipeline() throws Exception {
		...
		String text1 = net.scao.semanticmapping.util.IOUtil.readFile("testSentence.txt");
		Factory.initialize();
//		GeneralUtil.px(text1);
		ArrayList<String> sents = net.scao.semanticmapping.util.IOUtil.readLineList("testSentence.txt");
		for (String e: sents){
...
//				System.out.println(f);
			...
			for (HashSet<LinguisticConstruct> f: newMap.tokenAdjacencyList){
				for (LinguisticConstruct g: f){
					if (g.size() == bestLength){
						...
						DebugPrint.print(g.underlyingDimension);
	...
	public static void testOnTestSentence() throws Exception {
		ArrayList<String> l1 = net.scao.semanticmapping.util.IOUtil.readLineList("testSentence.txt");
		for (String e: l1){
