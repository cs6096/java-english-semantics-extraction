 ...
 */
package net.cs6096.semanticmapping.factory;
...
public class Factory {
	...
	public static void initialize() throws Exception {
		...
		basicPartOfSpeechGenerator = new PrimitiveGenerator() {
			...
			public void generate(TextConstructIndexMap map1) {
				try {
					for (int i = 0; i < map1.tokens.size(); i++) {
						...
						Set<String> temp = PartOfSpeechMarker.wordsPOS(cur);
			...
			private boolean registerAtomicConstruct(TextConstructIndexMap fillingIndexMap, String typeId, int index) {
...
//					if (false) {
//						if (typeId.equals("NOUN") || typeId.equals("PRONOUN") || typeId.equals("PROPER_NOUN")
